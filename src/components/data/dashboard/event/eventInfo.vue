<template>
  <div class="border border-gray-300 rounded-lg p-4 2xl:p-2 ">
    <img
      ...
      alt=""
      class="w-64 max-w-50 m-auto rounded-lg block aspect-square object-cover 2xl:w-72 md-max:w-64 xm-max:w-56"
    />
    <img 
      v-else 
      class=" max-w-80 m-auto rounded-lg block aspect-square object-cover 2xl:w-72 md-max:w-52 xm-max:w-52 "  
    ...
    <div class="space-y-1 divide-y">
      ...
      <div class="py-2">
        ...
        <div class="text-base font-medium text-gray-800" v-for="e in event?.categories" :key="e._id">
          <span 
