    ...
    <div class="col-span-6">
      <div class="bg-white w-full rounded-[16px] flex items-center p-5">
        ...
        <div>
          ...
          <div class="text-[20px] font-bold text-[#483D5B]">{{ store.deposit?.toLocaleString() || 0 }} сум</div> 
        </div>
      </div>
    </div>
    <div class="col-span-6">
      <div class="bg-white w-full rounded-[16px] flex items-center p-5">
        ...
        <div>
          ...
          <div class="text-[20px] font-bold text-[#483D5B]">{{ store.withdrawal?.toLocaleString() || 0 }} сум</div>
        </div>
      </div>
    </div>
    <div class="col-span-6">
      <div class="bg-white w-full rounded-[16px] flex items-center p-5">
        ...
        <div>
          ...
          <div class="text-[20px] font-bold text-[#483D5B]">{{ store.purchase?.toLocaleString() || 0 }} сум</div>
        </div>
      </div>
    </div>
    <div class="col-span-6">
      <div class="bg-white w-full rounded-[16px] flex items-center p-5">
        ...
        <div>
          ...
          <div class="text-[20px] font-bold text-[#483D5B]">{{ store.profit?.toLocaleString() || 0 }} сум</div>
        </div>
      </div>
    </div>
    <div class="col-span-12">
      <div class="bg-white w-full rounded-[16px]  items-center p-5">
        <div class="flex items-center justify-between mb-3">
          <h3 class="text-[18px] font-bold leading-6 text-[#483D5B] w-full">Статистика по (текуший месяц)</h3>
          <!-- <default-select
            v-model="search"
            name="title"
