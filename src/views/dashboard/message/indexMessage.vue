  ...
  <div class="grid grid-cols-12 overflow-hidden h-full gap-5 px-[20px] relative">
    <div class="col-span-3 h-full">
      <div class="flex items-center justify-between">
        <h2 class="text-[#645A77] text-[22px] font-bold">Чаты</h2>
        <button
          @click="openModal"
    ...
    <div
      class="flex-1 col-span-9 overflow-hidden space-y-4 flex flex-col h-full bg-white rounded-[26px] py-[25px] w-full"
    >
      ...
      <div class="border-t-2 z-40 p-4 flex flex-col justify-end" v-if="route.params.id">
        <div class="relative rounded-md w-full overflow-hidden">
          <textarea
            ...
            class="block w-full rounded-2xl py-3 pl-6 pr-12 text-[#483D5B] placeholder:text-gray-400 border focus:border-[#9E55EC] resize-none"
            placeholder="Напишите текст сообщение"
            aria-describedby="price-currency"
          />
          <!-- Smaylik Button -->
          <button
            class="absolute inset-y-3 right-16 flex items-center justify-center p-3 cursor-pointer rounded-full"
    ...
    <div
      ...
      class="absolute z-[9999] bottom-[120px] right-12 bg-white border shadow-md rounded-md p-2"
    >
